...
export default (editor: grapesjs.Editor, opts: RequiredPluginOptions) => {
  ...
  const imagePlaceholderSrc =
    opts.imagePlaceholderSrc ||
    'https://sg-smartlink-prod-1300342648.cos.ap-singapore.myqcloud.com/11/10423b01377a4d21906df9a2ec6a8eb4.png';
  ...
  const getI18nLabel = (label: string) => {
    return editor.I18n.t(`grapesjs-mjml.components.names.${label}`);
  };
