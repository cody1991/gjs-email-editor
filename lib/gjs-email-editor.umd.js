(function(){ try {var elementStyle = document.createElement('style'); elementStyle.appendChild(document.createTextNode(".gjs-pn-views-container,.gjs-pn-views{width:20%}.gjs-pn-commands{width:80%}.gjs-pn-options{right:20%}.gjs-cv-canvas{width:80%}.gjs-editor-cont input::-webkit-input-placeholder{color:#ccc}.gjs-editor-cont input::-moz-input-placeholder{color:#ccc}.gjs-editor-cont input::-ms-input-placeholder{color:#ccc}")); document.head.appendChild(elementStyle);} catch(e) {console.error('vite-plugin-css-injected-by-js', e);} })();(function(m,u){typeof exports=="object"&&typeof module<"u"?module.exports=u(require("juice")):typeof define=="function"&&define.amd?define(["juice"],u):(m=typeof globalThis<"u"?globalThis:m||self,m["gjs-email-editor"]=u(m.juice))})(this,function(m){"use strict";const u="",y=(a,r)=>{const i=a.Commands,t=a.getConfig().stylePrefix;i.add(r.cmdOpenImport,{createCodeViewer(){return a.CodeManager.createViewer({codeName:"htmlmixed",theme:r.codeViewerTheme,readOnly:!1})},createCodeEditor(){const e=document.createElement("div"),o=this.createCodeViewer();return e.style.flex="1 0 auto",e.style.boxSizing="border-box",e.className=`${t}import-code`,e.appendChild(o.getElement()),{codeEditor:o,el:e}},getCodeContainer(){let e=this.containerEl;return e||(e=document.createElement("div"),e.className=`${t}import-container`,e.style.display="flex",e.style.gap="5px",e.style.flexDirection="column",e.style.justifyContent="space-between",this.containerEl=e),e},run(e){const o=this.getCodeContainer();let{codeEditorHtml:l}=this;if(!l){const n=this.createCodeEditor(),s=document.createElement("button");if(l=n.codeEditor,this.codeEditorHtml=l,r.modalLabelImport){let d=document.createElement("div");d.className=`${t}import-label`,d.innerHTML=r.modalLabelImport,o.appendChild(d)}s.innerHTML=r.modalBtnImport,s.className=`${t}btn-prim ${t}btn-import`,s.style.alignSelf="flex-start",s.onclick=()=>{const d=n.codeEditor.editor.getValue();e.Components.clear(),e.Css.clear(),e.setComponents(d),e.Modal.close()},o.appendChild(n.el),o.appendChild(s)}e.Modal.open({title:r.modalTitleImport,content:o}),l&&(l.setContent(r.importPlaceholder||""),l.editor.refresh())}})},L=(a,r)=>{const i=a.Commands,t=a.getConfig().stylePrefix;i.add(r.cmdInlineHtml,{run(e,o,l={}){const n=e.getHtml()+`<style>${e.getCss()}</style>`;return m(n,{...l.juiceOpts,...l})}}),i.add("export-template",{createCodeViewer(){return a.CodeManager.createViewer({codeName:"htmlmixed",theme:r.codeViewerTheme})},createCodeEditor(){const e=document.createElement("div"),o=this.createCodeViewer();return e.style.flex="1 0 auto",e.style.boxSizing="border-box",e.className=`${t}export-code`,e.appendChild(o.getElement()),{codeEditor:o,el:e}},getCodeContainer(){let e=this.containerEl;return e||(e=document.createElement("div"),e.className=`${t}export-container`,e.style.display="flex",e.style.gap="5px",e.style.flexDirection="column",e.style.justifyContent="space-between",this.containerEl=e),e},run(e){let{codeEditorHtml:o}=this;const l=this.getCodeContainer();if(!o){const n=this.createCodeEditor();if(o=n.codeEditor,this.codeEditorHtml=o,r.modalLabelExport){let s=document.createElement("div");s.className=`${t}export-label`,s.innerHTML=r.modalLabelExport,l.appendChild(s)}l.appendChild(n.el)}if(e.Modal.open({title:r.modalTitleExport,content:l}),o){const n=`${e.getHtml()}<style>${e.getCss()}</style>`;o.setContent(r.inlineCss?m(n,r.juiceOpts):n),o.editor.refresh()}}})},x=(a,r)=>a.Commands.add(r.cmdTglImages,{run(i){const t=i.getComponents();this.toggleImages(t)},stop(i){const t=i.getComponents();this.toggleImages(t,!0)},toggleImages(i,t=!1){const e="##";i.forEach(o=>{if(o.get("type")==="image"){const l=o.get("src");t?l===e&&o.set("src",o.get("src_bkp")):l!==e&&(o.set("src_bkp",o.get("src")),o.set("src",e))}this.toggleImages(o.get("components"),t)})}}),h="set-device-desktop",H="set-device-tablet",C="set-device-mobile",v="canvas-clear",M=(a,r)=>{const{Commands:i}=a,t=r.textCleanCanvas;y(a,r),L(a,r),x(a,r),i.add(h,{run:e=>e.setDevice("Desktop"),stop:()=>{}}),i.add(H,{run:e=>e.setDevice("Tablet"),stop:()=>{}}),i.add(C,{run:e=>e.setDevice("Mobile portrait"),stop:()=>{}}),i.add(v,{run:e=>{const o="core:canvas-clear";t?confirm(t)&&e.runCommand(o):e.runCommand(o)}})};function w(a,r){a.Blocks;let i="",t="",e=r.tableStyle||{},o=r.cellStyle||{};const l=(d,g)=>{r.blocks.indexOf(d)>=0&&a.Blocks.add(d,{select:!0,...g,...r.block(d)})};for(let d in e)i+=`${d}: ${e[d]}; `;for(let d in o)t+=`${d}: ${o[d]}; `;l("sect100",{label:"1 Section",media:`<svg viewBox="0 0 24 24">
    ...
    `});const s=`<table class="list-item">
    ...
    </svg>`,content:s+s})}const $=(a,r)=>{const{Panels:i}=a,{cmdOpenImport:t,cmdTglImages:e}=r,o="export-template",l="open-sm",n="open-tm",s="open-layers",d="open-blocks",g="sw-visibility",f="fullscreen",b="preview",c='style="display: block; max-width: 22px"';a.getConfig().showDevices=!1,i.getPanels().reset([{id:"commands",buttons:[{}]},{id:"devices-c",buttons:[{id:h,command:h,active:!0,label:`<svg ${c} viewBox="0 0 24 24">
      ...
      `});const l=document.createElement("style");l.innerText=o,document.head.appendChild(l)}a.onReady(()=>{a.getWrapper().set("stylable",["width","margin","background-color","background"])}),M(a,t),w(a,t),$(a,t),k(a,t)}});
